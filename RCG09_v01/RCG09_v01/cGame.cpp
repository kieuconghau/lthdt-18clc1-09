...
cGame::cGame()
{
	...
	/* Level 1 */
	vector<cObject::ecType> objectTypes0 =	{ cObject::ecType::MIX_STONE_AND_COIN	, cObject::ecType::MV_CAR	, cObject::ecType::FE_COIN	, cObject::ecType::MV_CAR	, cObject::ecType::MA_BIRD		};
