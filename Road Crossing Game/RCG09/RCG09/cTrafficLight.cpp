...
cTrafficLight::cTrafficLight(unsigned int x, unsigned int y, unsigned int timeRed, unsigned int timeYellow, unsigned int timeGreen) : cObject(cTrafficLight::N, x, y), Times{timeRed, timeYellow, timeGreen} { }
